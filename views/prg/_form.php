...
$form->field($model, 'carrera')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\Carrera::find()->all(), 'carrera_id', 'nombre'),
    [
        'prompt' => 'Select',
...
$form->field($model, 'materia')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\Materia::find()->all(), 'materia_id', 'nombre'),
    [
        'prompt' => 'Select',
...
$form->field($model, 'catedra')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\Catedra::find()->all(), 'catedra_id', 'nombre'),
    [
        'prompt' => 'Select',
...
$form->field($model, 'plan')->dropDownList(
    \yii\helpers\ArrayHelper::map(app\models\Plan::find()->all(), 'plan_id', 'nombre'),
    [
        'prompt' => 'Select',
