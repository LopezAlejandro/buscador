...
* @return mixed
*/
public function actionView($materia_id)
{
...
'model' => $this->findModel($materia_id),
]);
}
...
return $this->redirect(['view', 'materia_id' => $model->materia_id]);
...
* @return mixed
*/
public function actionUpdate($materia_id)
{
$model = $this->findModel($materia_id);
...
* @return mixed
*/
public function actionDelete($materia_id)
{
try {
$this->findModel($materia_id)->delete();
} catch (\Exception $e) {
$msg = (isset($e->errorInfo[2]))?$e->errorInfo[2]:$e->getMessage();
...
*/
protected function findModel($materia_id)
{
if (($model = Materia::findOne($materia_id)) !== null) {
return $model;
} else {
