...
* @param integer $catedra_id
*
* @return mixed
*/
public function actionView($catedra_id)
{
...
'model' => $this->findModel($catedra_id),
]);
}
...
return $this->redirect(['view', 'catedra_id' => $model->catedra_id]);
...
* @return mixed
*/
public function actionUpdate($catedra_id)
{
$model = $this->findModel($catedra_id);
...
* @return mixed
*/
public function actionDelete($catedra_id)
{
try {
$this->findModel($catedra_id)->delete();
} catch (\Exception $e) {
$msg = (isset($e->errorInfo[2]))?$e->errorInfo[2]:$e->getMessage();
...
*/
protected function findModel($catedra_id)
{
if (($model = Catedra::findOne($catedra_id)) !== null) {
return $model;
} else {
